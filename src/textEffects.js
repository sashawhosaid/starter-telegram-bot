...
exports.applyTextEffect = void 0;
function applyTextEffect(str, variant, flags) {
    var offsets = {
        m: [0x1d670, 0x1d7f6],
        b: [0x1d400, 0x1d7ce],
        i: [0x1d434, 0x00030],
    ...
    var getFlag = function (flag, flags) {
        if (!flags)
            return false;
        return flag.split("|").some(function (f) { return flags.split(",").indexOf(f) > -1; });
    };
...
exports.applyTextEffect = applyTextEffect;
